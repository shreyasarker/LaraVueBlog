            ...
            <div class="row justify-content-around">
                <div class="col-md-10">
                    <div class="card card-primary">
                        ...
                        <form role="form" @submit.prevent="editPost" enctype="multipart/form-data">
                            <div class="card-body">
...
<script>
    export default {
        ...
        mounted(){
            ...
            axios.get('blogposts/edit/'+this.$route.params.id)
                .then((response) => {
        ...
        methods: {
            ...
            updateImage(){
                ...
                if(image.length > 100){
                    ...
                    return `post_images/${this.form.photo}`
                }
            },
            editPost(){
                this.form.post('/blogposts/edit/'+this.$route.params.id)
                    .then((response) => {
